...
# --enable-optimize=-O2 -GFLs -GS- -fp:precise -Qfast_transcendentals -Qpar is used by configure (not client.mk)
# --enable-jemalloc is used by configure (not client.mk)
# --disable-debug is used by configure (not client.mk)
# --enable-shared-js is used by configure (not client.mk)
...
# --enable-install-strip is used by configure (not client.mk)
...
export FOUND_MOZCONFIG := /e/mozdev/home/.mozconfig-x64-vs11
