...
static const CipherPref CipherPrefs[] = {
...
// Below ciphers are all deprecated (RSA key exchange)
 ...
 { "security.ssl3.rsa_des_ede3_sha",
   SSL_RSA_WITH_3DES_EDE_CBC_SHA, true }, // deprecated (3DES)
